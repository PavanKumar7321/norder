  ...
  const renderTimeline = (
    ...
    >
      {historyData.timeline.map((item, index) => {
        ...
        const lastTimeline = index === historyData.timeline.length - 1;
