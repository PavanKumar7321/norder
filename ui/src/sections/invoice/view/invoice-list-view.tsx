...
import { deleteInvoice, useGetInvoices } from 'src/api/invoice';
...
export default function InvoiceListView() {
  ...
  const notFound = (!dataFiltered.length && canReset) || invoicesEmpty;
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <InvoiceTableToolbar
            ...
            //
            dateError={dateError}
            serviceOptions={invoices.map((option) => option.items[0].title)}
          />
